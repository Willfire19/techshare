...
RSpec.describe DevicesController, :type => :controller do
  ...
  let(:valid_attributes) {
    ...
    { "name" => "Nexus 4", "availability" => "Available", "user_id" => 1, "contact_email" => "test@example.com" }
  }

  let(:invalid_attributes) {
    { "name" => "nope", "user_id" => nil, "contact_email" => nil}
  }
  ...
  describe "GET index" do
    ...
    it "is accessible when user is signed out" do
      sign_out user
      get :index, {}
  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved device as @device" do
        post :create, {:device => invalid_attributes}
        expect(assigns(:device)).to be_a_new(Device)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      ...
      it "updates the requested device" do
        device = Device.create! valid_attributes
        put :update, {:id => device.to_param, :device => new_attributes}
        device.reload
    ...
    describe "with invalid params" do
      it "assigns the device as @device" do
        device = Device.create! valid_attributes
        put :update, {:id => device.to_param, :device => invalid_attributes}
        expect(assigns(:device)).to eq(device)
      end
